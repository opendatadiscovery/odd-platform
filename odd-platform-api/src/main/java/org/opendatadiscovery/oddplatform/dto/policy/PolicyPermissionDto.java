...
public enum PolicyPermissionDto {
    ...
    DATASET_DESCRIPTION_UPDATE(DATA_ENTITY),
    DATASET_LABELS_UPDATE(DATA_ENTITY),
    DATASET_ENUMS_ADD(DATA_ENTITY),
    DATASET_ENUMS_UPDATE(DATA_ENTITY),
    DATASET_ENUMS_DELETE(DATA_ENTITY),
