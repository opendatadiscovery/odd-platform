...
@Component
public class TermAssignmentActivityHandler extends AbstractTermActivityHandler implements ActivityHandler {

    public TermAssignmentActivityHandler(final ReactiveTermRepository reactiveTermRepository) {
        super(reactiveTermRepository);
    }

    @Override
    public boolean isHandle(final ActivityEventTypeDto activityEventTypeDto) {
        return activityEventTypeDto == ActivityEventTypeDto.TERM_ASSIGNED;
    }
