...
public class ReactiveDataQualityRunsRepositoryImpl implements ReactiveDataQualityRunsRepository {
    ...
    @Override
    public Flux<DataQualityRunsRecord> getLatestDataQualityRunsResults() {
    ...
    @Override
    public Flux<TableHealthRecord> getLatestTablesHealth() {
    ...
    @Override
    public Flux<MonitoredtablesRecord> getMonitoredTables() {
