...
public interface ReactiveEnumValueRepository extends ReactiveCRUDRepository<EnumValuePojo> {
    Flux<EnumValueDto> getEnumState(final Collection<Long> datasetFieldIds);
    ...
    Flux<EnumValuePojo> getEnumValuesByDatasetFieldIds(final Collection<Long> datasetFieldIds,
