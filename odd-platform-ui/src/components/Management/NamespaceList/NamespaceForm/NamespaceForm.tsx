...
interface NamespaceFormProps extends StylesType {
  ...
  namespace?: Namespace;
  isLoading: boolean;
  createNamespace: (params: NamespaceApiCreateNamespaceRequest) => Promise<Namespace>;
  updateNamespace: (params: NamespaceApiUpdateNamespaceRequest) => Promise<Namespace>;
}
...
const NamespaceForm: React.FC<NamespaceFormProps> = ({
  ...
  const formTitle = <Typography variant="h4">{namespace ? 'Edit' : 'Add'} Namespace</Typography>;
