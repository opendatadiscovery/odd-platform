...
import { styles, StylesType } from './LabelsListSkeletonStyles';

interface SkeletonProps extends StylesType {
  length?: number;
}

const LabelsListSkeleton: React.FC<SkeletonProps> = ({
  classes,
  length,
}) => {
...
export default withStyles(styles)(LabelsListSkeleton);
