...
export const TermLinkedColumnsResultsTableHeader = styled(Grid)(({ theme }) => ({
  borderBottom: '1px solid',
  borderBottomColor: theme.palette.divider,
}));

export const TermLinkedColumnsColContainer = styled(Grid)<{
...
export const TermLinkedColumnsListContainer = styled(Grid)<{ $isListEmpty: boolean }>(
  ({ theme, $isListEmpty }) => ({
    height: $isListEmpty
      ? 'auto'
