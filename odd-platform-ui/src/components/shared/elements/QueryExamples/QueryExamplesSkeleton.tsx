...
const QueryExamplesSkeletonItem = ({ randWidth }: { randWidth: () => string }) => (
  <>
...
const QueryExamplesSkeleton: React.FC = () => (
  <SkeletonWrapper
    length={3}
    renderContent={({ randWidth, key }) => (
      ...
      >
        <Grid item xs={4} pl={theme => theme.spacing(1)}>
          <QueryExamplesSkeletonItem randWidth={randWidth} />
        </Grid>
...
export default QueryExamplesSkeleton;
