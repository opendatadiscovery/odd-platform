...
// The canonical star glyph. Since #1815 the star means "Favorite" everywhere, so this is the
// single source of the star path — `FavoriteStar` (the interactive toggle) reuses STAR_ICON_PATH
// rather than inlining its own byte-identical copy. Fill follows `currentColor` so callers control
// the colour via `color`/`htmlColor`/`sx` (the MUI SvgIcon convention).
