...
// import { OwnerAssociationRequestStatusParam, type OwnerAssociationRequest } from 'generated-sources';
...
//       (state, { payload }) => {
//         const { items, pageInfo, status } = payload;

//         if (status === OwnerAssociationRequestStatusParam.) {
