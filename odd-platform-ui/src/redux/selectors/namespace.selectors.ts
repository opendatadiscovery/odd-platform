...
const getNamespaceListFetchingStatus = createFetchingSelector('GET_NAMESPACES');
export const getNamespaceCreateStatus = createFetchingSelector('POST_NAMESPACES');
export const getNamespaceUpdateStatus = createFetchingSelector('PUT_NAMESPACE');
...
export const getNamespaceList = createSelector(namespacesState, namespaces =>
  namespaces.allIds.map(id => namespaces.byId[id])
);
